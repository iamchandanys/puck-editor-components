    ...
    components: {
        ViWithHeadingBlock: {
            ...
            render: function (_a) {
                ...
                return (<>
            <ViWithHeading title={title} description={description} allProductsBtn={allProductsBtn} advisorBtn={advisorBtn} bannerImg={bannerImg}></ViWithHeading>
          </>);
            },
        },
        InsuranceTypeBlock: {
            ...
            render: function (_a) {
                var title = _a.title, description = _a.description, items = _a.items;
                return (<InsuranceTypes title={title} description={description} items={items}></InsuranceTypes>);
            },
        },
        FeaturesListCardBlock: {
            ...
            render: function (_a) {
                var title = _a.title, description = _a.description, items = _a.items;
                return (<>
            <FeaturesListCard title={title} description={description} items={items}></FeaturesListCard>
          </>);
            },
        },
    },
